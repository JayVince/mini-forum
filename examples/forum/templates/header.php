               ...
               <div class="container">
                    <div class="row">
                         <div class="col-sm-8 col-md-6 py-4">
                              ...
                              <p class="text-muted">M-Forum is the most significant global network of Volunteering for Developer community. M-Forum exists to share information, develop good practice and enhance cooperation across the volunteering for development and open source industry. It promotes the value of volunteering through policy engagement, mutual learning and by sharing innovative and good practices. M-Forum is a ‘virtual’ network, with a global membership that includes a range of organisations involved in international development.</p>
                         </div>
